...
This repository uses `micro_django_tailwind_htmx_template_for_frontend_demo` as project name.
...
This step will create the virtual environment (henceforth venv for short) `/path/to/your/project/.venv/micro_django_tailwind_htmx_template_for_frontend_demo-31013` and then create a symlink `/path/to/your/project/.venv/micro_django_tailwind_htmx_template_for_frontend_demo` pointing to this venv.
...
1. run `source ~/.venv/micro_django_tailwind_htmx_template_for_frontend_demo/bin/activate` to turn on the virtual environment
